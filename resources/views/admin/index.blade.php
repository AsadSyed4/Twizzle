                                ...
                                <div class="col-lg-6 col-md-12 col-6 mb-4">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            @endphp
                                            <h3 class="card-title mb-2">$@if (!is_null($balance))
                                                    {{ $balance->balance }}
                                                @else
                                                    0
                                                @endif
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h3 class="card-title mb-2">
                                                ${{ \App\Models\Transection::where('admins_id', '=', session()->get('admin.id'))->where('description', '=', 'Income')->sum('balance') }}
                                            </h3>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6 col-lg-4 order-2 mb-4">
                            <div class="card h-100">
                                ...
                                <div class="card-body">
                                    <ul class="p-0 m-0">
                                        @php
                                            $transections = \App\Models\Transection::where('admins_id', '=', session()->get('admin.id'))
                                                ->orderBy('created_at', 'desc')
                                                ->take(10)
                                                ->get();
                                        @endphp
                                        @foreach ($transections as $transection)
                                            @if ($transection->transection_type == 'In')
                                                <li class="d-flex">
                                                    <div class="avatar flex-shrink-0 me-3">
                                                        <img src="{{ asset('admin/assets/img/icons/unicons/cc-success.png') }}"
                                                            alt="User" class="rounded" />
                                                    ...
                                                    <div
                                                        class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                                        <div class="me-2">
                                                            <small class="text-muted d-block mb-1">{{ $transection->description }}</small>
                                                        </div>
                                                        <div class="user-progress d-flex align-items-center gap-1">
                                                            <h6 class="mb-0 text-success">+{{ $transection->balance }}</h6>
                                                            <span class="text-muted">USD</span>
                                                        </div>
                                                    </div>
                                                </li>
                                            @else
                                                <li class="d-flex">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="user-progress d-flex align-items-center gap-1">
                                                            <h6 class="mb-0 text-danger">-{{ $transection->balance }}</h6>
                                                            <span class="text-muted">USD</span>
                                                        </div>
                                                    </div>
                                                </li>

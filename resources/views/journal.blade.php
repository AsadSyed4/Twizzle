    ...
    <div class="app">
        <div class="container">
            <div class="app_inner">
                ...
                <div class="entry">
                    <div class="left_side">
                        <form class="box" id="my_form" action="{{ url('/add-journal') }}" method="POST">
                            @csrf
                            <span>
                                <h3>Journal</h3>
                                <a class="planner_btn" onclick="document.getElementById('my_form').submit();">Save</a>
                            </span>
                            <input id="name" name="name" value="{{ old('name') }}" type="text" style="padding: 2%;border-radius: 5px;border: 2px solid #D5DAE1;background: rgba(255, 255, 255, 0.95);font-style: normal;font-family: 'AvantGarde Bk BT';letter-spacing: 0.02em;color: #0B0519;width: 95.5%;margin-top: 20px;"
                                placeholder="This journal is only for you. Give it a title that is easy to remember and most intuitive." required>
                            <textarea name="description" id="description" placeholder="This is a space for you to keep notes on not only what you did but what you learned and felt. Since over time you will forget the details of each event, the journal will help keep the important parts for your Common App essay safely stored for future use."></textarea>                            
                        </form>
                    </div>
